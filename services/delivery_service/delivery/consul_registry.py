...
def register_service():
    ...
    payload = {
        ...
        "Tags": [
            "traefik.enable=true",
            "traefik.http.routers.delivery.rule="
            "PathPrefix(`/api/deliveries`) || PathPrefix(`/api/drivers`) || "
            "PathPrefix(`/api/companies`) || PathPrefix(`/api/offices`) || "
            "PathPrefix(`/api/delivery`)",
