...
PRODUCTS = {
    "Rouiba Market": [
        {
            ...
            "name": "Whole Milk",
            "description": "Full-fat cow's milk (1L)",
            "price": Decimal("0.90"),
            "stock": 150
        }, {
            "name": "Eggs",
    ...
    "Sara's Bakery": [
        {
            ...
            "name": "Almond Cake",
            "description": "Moist almond and honey cake (slice)",
            "price": Decimal("3.50"),
            "stock": 40
        }, {
    ...
    "Fresh Catch Seafood": [
        {
            "name": "Sardines",
            "description": "Fresh whole sardines (1kg)",
            "price": Decimal("4.50"),
            "stock": 70
        }, {
            "name": "Shrimp",
            "description": "Peeled king shrimp (500g)",
            "price": Decimal("12.99"),
            "stock": 35
        }, {
            "name": "Sea Bass",
            "description": "Whole sea bass, gutted and scaled",
            "price": Decimal("9.99"),
            "stock": 20
        },
    ],
    "Karim Electronics": [
        {
            "name": "Gaming Mouse",
            "description": "RGB optical gaming mouse, 12000 DPI",
            "price": Decimal("34.99"),
            "stock": 45
        }, {
            "name": "Mechanical Keyboard",
            "description": "TKL mechanical keyboard, brown switches",
            "price": Decimal("79.99"),
            "stock": 20
        }, {
            "name": "Monitor Stand",
